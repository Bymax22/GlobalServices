...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-slate-950/80 backdrop-blur-sm">
      <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between rounded-full bg-white px-4 py-2 shadow-lg shadow-slate-950/10 sm:px-6 sm:py-2.5">
